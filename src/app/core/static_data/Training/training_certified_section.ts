export const TrainingRCACertifiedStrings: any = {
  en: {
  ...
  ar: {
    ...
    desc: `صُممت برامجنا التدريبية لتحليل السبب الجذري لإعدادك للحصول على شهادة، وهي من المؤهلات المعترف بها على نطاق واسع في مجال حل المشكلات وصناعة القرار.<br />فقط املأ البيانات المطلوبة أدناه، وسُنرسل إليك مزيدًا من المعلومات عن برنامجنا شاملة جداول المواعيد والمحاضرات والأسعار وخيارات الاعتماد.`,
