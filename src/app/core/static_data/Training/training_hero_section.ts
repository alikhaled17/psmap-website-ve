export const TrainingHeroStrings: any = {
  en: {
  ...
  ar: {
    ...
    desc: `أتقِن فن حل المشكلات وادفع مسيرتك المهنية إلى الأمام؛ سواءً أكُنت فردًا أو مؤسسة.`,
    trial_btn: "ابدأ التدريب على تحليل السبب الجذري اليوم",
  },
};
